...
<!--            <tinymce :width="595" :height="300" v-model="value.detailHtml"></tinymce>-->
            <custom-editor :width="595" :height="300" v-model="value.detailHtml"></custom-editor>
          </el-tab-pane>
          <el-tab-pane label="移动端详情" name="mobile">
<!--            <tinymce :width="595" :height="300" v-model="value.detailMobileHtml"></tinymce>-->
            <custom-editor :width="595" :height="300" v-model="value.detailMobileHtml"></custom-editor>
...
<script>
  ...
  export default {
    ...
    components: {SingleUpload, MultiUpload, CustomEditor},
    props: {
      value: Object,
      isEdit: {
        type: Boolean,
